...
function create_grid(){
	...
	#region Create Initial Pieces
		...
		global.turnsystem.teams[global.turnsystem.currentTurn].create_piece(global.unitInformation[2], true, positionBLUE)
		...
		global.turnsystem.teams[global.turnsystem.currentTurn].create_piece(global.unitInformation[2], true, positionRED)
